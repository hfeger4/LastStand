...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__start__ = __webpack_require__(5);
...
class Ball{
  ...
  updateX(x) {
   ...
   restartGame(){
     ...
     this.shipX = (this.ballX - this.shipWidth)/2;
     this.ballX = ctx.canvas.height/2;
     this.ballX = ctx.canvas.height-30;
   }
  ...
  renderDrawBricks() {
    for(let a = 0; a < this.brickCol; a++) {
        for(let b = 0; b < this.brickRow; b++) {
          ...
          if(oneBrick.hits > 0){
            let brickXPos = (a * (this.brickPadding +
            this.brickWidth)) + this.leftpadding;
            let brickYPos = (b * (this.brickPadding +
            this.brickHeight)) + this.topPadding;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ball2__ = __webpack_require__(4);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__bricks__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__start__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ball2__ = __webpack_require__(4);
