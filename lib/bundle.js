...
class Ball{
  constructor(){
    ...
    // document.addEventListener("keydown", this.ballHandler.bind(this), false);
  ...
  updateX(x) {
   ...
   wallInteraction() {
     if(this.ballX < canvas.width && this.ballY + this.directionY > canvas.height - this.r){
       ctx.font = "3em Serif";
       ctx.fillStyle = "#FFFFFF";
       ctx.fillText("Game Over", 285, 270);
       this.directionX = 0;
  ...
  // arrowLogic(){
  //   if(rightArrow && this.shipX < canvas.width - this.shipWidth){
  //     this.shipX += 7;
  //   }
  //   else if(leftArrow && this.shipX > 0){
  //     this.shipX -= 7;
  //   }
  // }
  //
